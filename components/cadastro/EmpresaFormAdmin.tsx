...
export function EmpresaFormAdmin() {
  ...
  return (
    <div className="space-y-6 mt-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-primary font-bold flex items-center gap-1 cursor-help opacity-70 hover:opacity-100 transition-opacity">
                  <PlusCircle className="h-3 w-3" /> Gerenciar Categorias
                </span>
              </div>
              <Controller
      ...
      <div className="grid md:grid-cols-2 gap-4 pt-2 border-t mt-4">
        <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            className={`rounded-xl resize-none h-24 ${errors.empresa?.descricao_produtos ? "border-red-500 bg-red-50" : ""}`}
          />
        ...
        <div className="space-y-2">
          ...
          <Textarea 
            ...
            className={`rounded-xl h-24 resize-none ${errors.empresa?.apresentacao ? "border-red-500 bg-red-50" : ""}`}
          />
